package com.david.message.solution.abstraction;
 ...
 * 处理消费消息
 */
public class AbstractConsumeMessage {
    private static Logger logger = LoggerFactory.getLogger(AbstractConsumeMessage.class);
